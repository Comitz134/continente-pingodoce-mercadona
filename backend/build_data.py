...
PASSOS = {
    "sardinhas": [
        "Liga o grelhador ou o forno no máximo e arranja as sardinhas (pede para as amanharem na peixaria).",
        "Tempera com sal grosso e pincela com um fio de azeite.",
        "Grelha ou assa 3–4 minutos de cada lado até a pele ficar dourada.",
    ...
    "caldeirada": [
        ...
        "Num tacho largo, aquece o azeite e refoga a cebola, o pimento e o tomate picados.",
        "Junta as batatas às rodelas e água quente até quase cobrir. Deixa cozer 10 minutos.",
        "Adiciona o peixe e cozinha em lume brando mais 10–15 minutos, sem mexer muito.",
    ],
    "salada-salmao": [
        "Grelha ou passa o salmão na frigideira com um fio de azeite, 2–3 minutos de cada lado.",
    ...
    "salmao-teriyaki": [
        ...
        "Grelha ou assa os lombos 3–4 minutos de cada lado, pincelando com a marinada.",
    ...
    "salmao-forno": [
        ...
        "Assa 18–20 minutos até o salmão estar cozinhado.",
    ],
    "empadao-peixe": [
        "Coze o peixe em leite com uma folha de louro. Reserva o leite e desfaz o peixe.",
        "Coze as batatas e esmaga-as com manteiga e um pouco do leite.",
        "Faz um creme com a farinha e o leite, junta o peixe e as ervilhas.",
        "Monta com o peixe por baixo e o puré por cima; leva ao forno a 200 °C até dourar.",
    ],
    "paella": [
        "Refoga o pimento e o alho no azeite.",
    ...
    "atum-nicoise": [
        "Coze as batatas, os ovos e o feijão-verde (os ovos 9–10 minutos).",
    ...
    "frango-piripiri": [
        ...
        "Grelha ou assa o frango até ficar dourado e cozinhado.",
    ...
    "frango-basco": [
        ...
        "Na mesma panela refoga o pimento, a cebola e o alho.",
        "Junta o tomate e deixa apurar, depois volta a colocar o frango.",
        "Tapa e cozinha 20–25 minutos até o molho engrossar.",
    ],
    "cuscuz-frango": [
        "Salteia o frango temperado no azeite até dourar.",
        "Junta legumes a gosto e água ou caldo; deixa cozinhar.",
    ...
    "prego": [
        ...
        "Aquece uma frigideira bem quente com azeite e frita os bifes 1–2 minutos de cada lado.",
        "Tosta o pão na gordura do bife.",
        "Monta o prego no pão e serve logo.",
    ],
    "febras": [
        "Tempera as febras com sal, alho, louro e um fio de azeite.",
        "Grelha ou assa na airfryer até ficarem douradas e cozinhadas.",
        "Deixa repousar 2 minutos antes de servir.",
        "Serve com arroz e salada.",
    ],
    "strogonoff": [
        "Aloura a carne cortada em tiras no azeite ou manteiga. Retira.",
        "Refoga a cebola e os cogumelos; junta mostarda e um pouco de caldo.",
        "Volta a colocar a carne e junta as natas.",
        "Cozinha 5 minutos e serve com arroz ou puré.",
    ],
    "vaca-brocolos": [
        "Salteia a carne em tiras num wok bem quente. Retira.",
        "Salteia os brócolos com o alho e o gengibre.",
        "Junta a carne, o molho de soja e um pouco de água.",
        "Cozinha 2–3 minutos e serve com arroz.",
    ],
    "moussaka": [
        "Frita ou assa as rodelas de beringela até ficarem macias.",
        "Prepara o recheio de carne com tomate e especiarias.",
        "Monta camadas de beringela, carne e bechamel.",
        "Assa a 180 °C até dourar (35–40 minutos).",
    ],
    "carbonara": [
        "Coze o esparguete em água com sal.",
        "Salteia a pancetta até ficar crocante.",
        "Mistura as gemas com o pecorino e pimenta.",
        "Junta a massa à pancetta, tira do lume e envolve com as gemas até formar o creme.",
    ],
    "bolonhesa": [
        "Refoga a cebola, o alho e a cenoura.",
        "Junta a carne picada e deixa alourar.",
        "Adiciona o tomate, a polpa e um pouco de caldo; cozinha 30 minutos em lume brando.",
        "Coze o esparguete e serve com o molho e parmesão.",
    ],
    "lasanha": [
    ...
    "fettuccine": [
        "Coze o fettuccine em água com sal.",
        "Derrete a manteiga e junta as natas e o parmesão até engrossar.",
        "Envolve a massa no molho.",
        "Serve com mais parmesão e pimenta.",
    ],
    "arrabiata": [
        "Refoga o alho e a malagueta no azeite.",
        "Junta o tomate e deixa apurar 10–15 minutos.",
        "Coze o penne e envolve no molho.",
        "Serve com salsa e parmesão.",
    ],
    "tortilha": [
        "Bate os ovos com sal.",
        "Salteia a batata e a cebola até ficarem macias.",
        "Mistura os legumes nos ovos.",
        "Coze dos dois lados numa frigideira (ou no microondas num recipiente untado).",
    ],
    "shakshuka": [
        "Refoga a cebola, o pimento e o alho.",
        "Junta o tomate e as especiarias; cozinha até engrossar.",
        "Abre buracos e parte os ovos por cima.",
        "Tapa e cozinha até as claras firmarem.",
    ],
    "chili-vegetariano": [
        "Refoga a cebola, o alho e o pimento.",
        "Junta o feijão, o tomate, o milho e as especiarias.",
        "Deixa cozinhar 15–20 minutos.",
        "Serve com arroz ou tortilhas.",
    ],
    "falafel": [
        "Tritura o grão-de-bico com a cebola, o alho, a salsa e as especiarias.",
        "Forma bolinhas ou discos.",
        "Coze na airfryer (ou frita) até dourar.",
        "Serve com pão pita, iogurte e salada.",
    ],
    "ratatouille": [
        "Corta a beringela, a curgete, o pimento e o tomate em rodelas ou cubos.",
        "Refoga a cebola e o alho; junta os legumes em camadas.",
        "Rega com azeite e tomilho.",
        "Assa a 190 °C até os legumes ficarem macios (35–40 minutos).",
    ],
    "fajitas-grao": [
        "Salteia a cebola e o pimento.",
    ...
    "lentilhas-abobora": [
        ...
        "Cozinha 20–25 minutos até a abóbora desfazer.",
        "Tempera com cominhos e pimenta e serve.",
    ],
    "dal": [
        "Lava as lentilhas e coze-as com água e curcuma.",
        "Noutra panela, faz o tempero com alho, gengibre e especiarias no azeite.",
        "Junta o tempero às lentilhas e cozinha mais 5 minutos.",
        "Serve com arroz.",
    ],
    "feijao-curry": [
        "Refoga a cebola, o alho e o gengibre.",
        "Junta o caril e o tomate; cozinha 5 minutos.",
        "Adiciona o feijão e o leite de coco.",
        "Cozinha 10 minutos e serve com arroz.",
    ],
    "rotolo": [
        "Salteia os cogumelos com o alho e os espinafres.",
        "Estende a massa, cobre com o recheio e enrola.",
        "Envolve em película e coze 20 minutos (ou assa).",
        "Corta em fatias e serve com molho de tomate.",
    ],
    "batatas-bravas": [
        "Corta as batatas em cubos e tempera.",
        "Assa na airfryer ou forno até ficarem douradas e crocantes.",
        "Prepara o molho bravo com tomate, alho e malagueta.",
        "Serve as batatas com o molho por cima.",
    ],
    "salada-massa": [
        "Coze a massa e arrefece em água fria.",
        "Junta o tomate, o pepino, o pimento, as azeitonas e o feta.",
        "Tempera com azeite, limão e orégãos.",
        "Serve fria.",
    ],
    "pasteis-nata": [
        "Aquece o leite com o açúcar e a canela.",
        "Junta a farinha e as gemas, mexendo até engrossar (creme).",
        "Forra as formas com massa folhada e enche com o creme.",
        "Assa a 250 °C até queimar ligeiramente por cima.",
    ],
    "crumble": [
        "Descasca e corta as maçãs; coze com açúcar e canela.",
    ...
    "panquecas-banana": [
        ...
        "Coze pequenas porções na frigideira até dourar dos dois lados.",
        "Serve com mel ou fruta.",
    ],
    "empanadas-camarao": [
        "Salteia o camarão com o alho e o cebolinho. Deixa arrefecer.",
        "Corta círculos na massa quebrada.",
        "Recheia, fecha e pincela com ovo.",
        "Assa ou frita até dourar.",
    ],
}
...
NOVAS = [
    {
        ...
        "passos": [
            ...
            "Aquece o azeite, junta o chouriço e cozinha 2 minutos; adiciona as batatas e deixa dourar mais 5 minutos.",
    ...
    },
    {
        ...
        "passos": [
            ...
            "Aquece uma frigideira untada e cozinha as panquecas 1 minuto de cada lado, até dourar.",
    ...
    },
    {
        ...
        "passos": [
            ...
            "Unta uma frigideira com manteiga e coze pequenas porções, virando quando borbulhar.",
    ...
    },
    {
        ...
        "passos": [
            ...
            "Refoga a cebola, o gengibre e a erva-príncipe no óleo restante.",
    ...
    },
    {
        ...
        "passos": [
            "Refoga o azeite com a cebola, o aipo, a cenoura, as batatas e o louro durante 10–15 minutos.",
            "Junta a polpa, o tomate, os cubos de caldo e 1 L de água a ferver; coze 15 minutos.",
            "Tritura até ficar cremosa.",
            "Junta o leite, aquece sem ferver e serve.",
        ],
    },
    {
        ...
        "passos": [
            "Refoga a cebola no azeite até ficar macia.",
            "Junta o grão-de-bico e o caldo; deixa ferver e cozinha 20 minutos.",
    ...
    },
    {
        ...
        "passos": [
            ...
            "Grelha 3–4 minutos de cada lado até ficarem dourados.",
    ...
    },
    {
        ...
        "ingredientes": [("Azeite", "2 c. sopa"), ("Cebola roxa", "1 unidade"), ("Alho", "4 dentes"),
                         ...
                         ("Pão pita", "4 unidades")],
        "passos": [
            "Refoga a cebola no azeite; junta o alho e as especiarias e cozinha mais 2 minutos.",
            "Reserva metade; à restante junta o tomate e deixa apurar 10 minutos.",
            "Mistura a carne com a cebola reservada, os alperces picados, o pão ralado e a hortelã; forma almôndegas.",
            "Cozinha as almôndegas no molho 15 minutos e serve com pão pita.",
        ],
    },
    {
        ...
        "passos": [
            "Panha o peito de frango em farinha, ovo e pão ralado e frita até dourar.",
            "Para o molho, refoga a cebola, o alho e a cenoura; junta a farinha e o caril.",
            "Adiciona o caldo, o mel e o molho de soja e deixa engrossar 15 minutos.",
    ...
    },
    {
        ...
        "ingredientes": [("Batatas", "300 g"), ("Feijão-verde", "150 g"), ("Óleo", "1 c. sopa"),
                         ...
                         ("Arroz", "300 g")],
        "passos": [
            "Coze as batatas 5 minutos; junta o feijão-verde e coze mais 3 minutos. Escorre.",
            "Aquece o óleo, salteia o alho e junta a pasta de caril.",
            "Adiciona o leite de coco, o molho de peixe e o frango; cozinha 10 minutos.",
    ...
    },
    {
        ...
        "passos": [
            ...
            "Aloura as costeletas no óleo 3 minutos de cada lado; retira.",
            "Refoga a cebola e o tomate na mesma frigideira até apurar.",
            "Volta a colocar as costeletas no molho, cozinha 5 minutos e serve com coentros.",
        ],
    },
    {
    ...
    },
    {
        ...
        "passos": [
            ...
            "Deita sobre a base e assa 45 minutos; deixa arrefecer antes de servir.",
        ],
    },
    {
        ...
        "passos": [
            "Derrete a manteiga e refoga a cebola sem deixar ganhar cor.",
            "Junta o arroz e mexe; adiciona o vinho e deixa absorver.",
            "Adiciona o caldo aos poucos, mexendo, até o arroz ficar cremoso.",
    ...
    },
    {
        ...
        "passos": [
            ...
            "Na mesma panela, frita o bacon, as cebolinhas, os cogumelos e o alho.",
    ...
    },
    {
        ...
        "passos": [
            ...
            "Refoga esta pasta no óleo 5 minutos; junta a carne, o molho de soja, as especiarias e o caldo.",
            "Tapa e cozinha 1 h 15, depois destapa mais 15 minutos até a carne ficar tenra.",
    ...
    },
    {
        ...
        "ingredientes": [("Caldo de galinha", "1 L"), ("Pasta de caril vermelho", "1 c. chá"),
                         ...
                         ("Coentros", "q.b.")],
        "passos": [
            "Ferve o caldo com a pasta de caril.",
    ...
    },
    {
        ...
        "passos": [
            "Refoga a cebola e a cenoura no azeite.",
    ...
    },
    {
        ...
        "passos": [
            ...
            "Frita em óleo quente até dourar dos dois lados.",
    ...
    },
    {
        ...
        "passos": [
            ...
            "Deixa o caldo ferver 20 minutos e tempera com molho de peixe.",
    ...
    },
    {
        ...
        "ingredientes": [("Macarrão", "250 g"), ("Manteiga", "2 c. sopa"), ("Queijo cheddar", "250 g"),
                         ...
                         ("Pão ralado", "2 c. sopa")],
        "passos": [
            "Coze o macarrão em água com sal; escorre e mistura com a manteiga.",
    ...
    },
    {
        ...
        "passos": [
            ...
            "Aquece o azeite numa frigideira e cozinha as batatas até dourar.",
